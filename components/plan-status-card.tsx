...
const PREMIUM_PLAN_URL = "https://wa.me/554588052041"
const PREMIUM_INSTALLMENT_URL = "https://wa.me/554588052041"
          ...
          <div className="mt-6">
            <div className="bg-slate-900/50 border-2 border-cyan-500 rounded-lg p-8">
              <div className="text-center mb-8">
                <div className="text-5xl font-bold text-white mb-2">R$ 347,00</div>
