...
const MAPA = {
  "Pré-natal e Obstetrícia": [
    "pré-natal","Sangramento no primeiro trimestre",
    "Isoimunização Rh e profilaxia com imunoglobulina anti-D","Diabetes gestacional",
    "Hipertensão na gestação / pré-natal","Atenção pré-natal / calendário de consultas",
    "sífilis gestacional – falha terapêutica","Sífilis na gestação",
    ...
    "Obstetrícia / HIV na gestação / Indicação de cesariana","Gestação ectópica",
    "Dor pélvica aguda / gestação ectópica","Abortamento",
    "Infertilidade / Avaliação inicial do casal",
  ...
  "Ginecologia Geral": [
    ...
    "Ginecologia / Sangramento uterino anormal na adolescência",
    "Doença inflamatória pélvica aguda","Ginecologia / vaginite por Trichomonas",
    "Sangramento uterino anormal e investigação endometrial",
    "Distúrbios menstruais na adolescência","Sangramento uterino anormal agudo",
    "Planejamento familiar e enxaqueca com aura",
    "Planejamento reprodutivo / HIV e contracepção",
    "Planejamento familiar / interação medicamentosa (anticonvulsivante)",
  ],
  "IST / Infecções Ginecológicas": [
    "IST / sífilis / manejo em contato sexual",
    "Rastreamento do câncer de colo uterino / conduta frente a LSIL",
    "Rastreamento de câncer de colo / lesão de alto grau",
    "Rastreamento do câncer de colo uterino com achado de ASC-US",
  ],
  "Oncologia Ginecológica": [
    "Oncoginecologia / tumor de ovário","Nódulo mamário em mulher jovem","Oncologia Ginecológica",
  ],
  "Endocrinologia Reprodutiva": [
    "Endocrinologia Ginecológica","Endocrinologia / hiperparatiroidismo primário",
    "Endocrinologia","Doença autoimune – lúpus",
  ],
